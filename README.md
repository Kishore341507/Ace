...
==========
<span style="color:red;">Note: The bot currently supports Python 3.11 correctly and might malfunction a bit with python 3.12.</span>

.. image:: https://discord.com/api/guilds/336642139381301249/embed.png
   :target: https://discord.gg/KeDwvbU5Zf
   :alt: TickAP Support Server
...
1. In your teminal run the command mentioned below. [Make sure you have python already set up for your system.].
.. code:: sh

    $ pip install -r requirements.txt

2. You will now have to additionally install the latest version of discord.py library. Follow the upcoming steps to do so.
.. code:: sh
...
- `TickAp Website <https://tickap.com/>`_
- `Invite me to your server <https://tickap.com/bots>`_
- `TickAp Support Server <https://discord.gg/KeDwvbU5Zf>`_
